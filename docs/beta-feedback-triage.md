...
| BF-022-006 | URL verification / 2026-07-09 | Automated HTTP check / N/A | N/A | Store metadata / Compliance | Medium | `/privacy`, `/terms`, and `/support` aliases return 404. | Every entered URL is live / Short aliases are unavailable. | Add to future backlog / Deferred | Canonical `/privacy-policy`, `/terms-of-service`, and `/contact` URLs are live and used. |
