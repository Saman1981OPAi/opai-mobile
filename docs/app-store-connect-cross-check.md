# App Store Connect Cross-Check

Complete against the exact selected build and current App Store Connect record.

- [ ] App name is `OPAi Police` and matches the binary.
- [ ] Subtitle is approved and within Apple's limit.
- [ ] Primary category is Productivity; secondary category is confirmed if used.
- [ ] Live Privacy Policy, Support, and optional Marketing URLs are entered.
- [ ] Description and promotional text match local/mock functionality without overpromising.
